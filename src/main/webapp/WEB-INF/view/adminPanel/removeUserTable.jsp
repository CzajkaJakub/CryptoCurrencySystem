...
<div class="content">
    ...
    <table class="container">
        <thead>
        <tr>
            <c:url var="sortLinkId" value="/adminSystem/showTableToRemove">
                <c:param name="sort" value="<%= Integer.toString(SortUtilsUsers.id_sort) %>" />
            </c:url>
            <c:url var="sortLinkLogin" value="/adminSystem/showTableToRemove">
                <c:param name="sort" value="<%= Integer.toString(SortUtilsUsers.login_sort) %>" />
            </c:url>
            <c:url var="sortLinkPassword" value="/adminSystem/showTableToRemove">
                <c:param name="sort" value="<%= Integer.toString(SortUtilsUsers.password_sort) %>" />
            </c:url>
            <c:url var="sortLinkEmail" value="/adminSystem/showTableToRemove">
